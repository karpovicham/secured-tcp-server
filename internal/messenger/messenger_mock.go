...
type MessengerMock struct {
	...
	funcSend          func(msgType proto.Type, msgData []byte) (err error)
	inspectFuncSend   func(msgType proto.Type, msgData []byte)
...
func (mmSend *mMessengerMockSend) Expect(msgType proto.Type, msgData []byte) *mMessengerMockSend {
	...
	mmSend.defaultExpectation.params = &MessengerMockSendParams{msgType, msgData}
...
func (mmSend *mMessengerMockSend) Inspect(f func(msgType proto.Type, msgData []byte)) *mMessengerMockSend {
...
func (mmSend *mMessengerMockSend) Set(f func(msgType proto.Type, msgData []byte) (err error)) *MessengerMock {
	if mmSend.defaultExpectation != nil {
...
// Then helper
func (mmSend *mMessengerMockSend) When(msgType proto.Type, msgData []byte) *MessengerMockSendExpectation {
	if mmSend.mock.funcSend != nil {
		mmSend.mock.t.Fatalf("MessengerMock.Send mock is already set by Set")
	}
	...
	expectation := &MessengerMockSendExpectation{
		mock:   mmSend.mock,
		params: &MessengerMockSendParams{msgType, msgData},
	}
...
func (mmSend *MessengerMock) Send(msgType proto.Type, msgData []byte) (err error) {
	...
	if mmSend.inspectFuncSend != nil {
		mmSend.inspectFuncSend(msgType, msgData)
	}

	mm_params := &MessengerMockSendParams{msgType, msgData}
	...
	if mmSend.SendMock.defaultExpectation != nil {
		...
		mm_got := MessengerMockSendParams{msgType, msgData}
	...
	if mmSend.funcSend != nil {
		return mmSend.funcSend(msgType, msgData)
	}
	mmSend.t.Fatalf("Unexpected call to MessengerMock.Send. %v %v", msgType, msgData)
	return
}
